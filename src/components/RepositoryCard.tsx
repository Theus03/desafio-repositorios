...
<div className="p-4 container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-3 gap-4">
    <div className="h-full w-full border-2 border-gray-500 border-opacity-60 rounded-lg overflow-hidden hover:border-gray-800 transition duration-200 ease-in cursor-pointer">
      <div className="p-2 flex">
        ...
        <div className="p-6">
            <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{repo.name}</h1>
